...
const ACTION_COLORS: Record<string, string> = {
  ...
  ROUND_PAUSED: '#ff6d00',
  ROUND_RESUMED: '#69ff47',
  USER_APPROVED: '#69ff47',
  USER_REJECTED: '#ff1744',
  USER_DELETED: '#ff1744',
  VIRTUAL_CREATED: '#b388ff',
  VIRTUAL_SCATTER: '#00e5ff',
...
const ACTION_LABELS: Record<string, string> = {
  ...
  ROUND_PAUSED: 'Khóa phòng',
  ROUND_RESUMED: 'Mở phòng',
  USER_APPROVED: 'Duyệt người dùng',
  USER_REJECTED: 'Từ chối người dùng',
  USER_DELETED: 'Xóa người dùng',
  VIRTUAL_CREATED: 'Tạo người chơi ảo',
  VIRTUAL_SCATTER: 'Rải cược ảo',
